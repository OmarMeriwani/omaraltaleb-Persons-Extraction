...
familyRelations3 = ['اب','ابو', 'ام', 'اخ','اخو','ابا','اخا', 'اخت', 'عم', 'خال', 'خال', 'خالة','خالت', 'جد','جدة','جدت','حفيد','حفيدة','حفيدت','نسيب','نسيبة','نسيبت','حما','حمو','والد','والدة','والدت','زوج','زوجة','زوجت','كنت','شقيق','شقيقة','شقيقت','ابن','ابنة','ابنت','قرابة','زواج','ابناء','أولاد','اخوة','عمومة']
...
study3 = ['طالب']
work = ['مدير','وظيفة','وظائف','مسؤول','جريدة','معمل','مصنع','صحيفة','مجلة','معمل','دائرة','مدرسة','جامع','مسجد','كنيسة','كاتدرائية','ثانوية','إعدادية','وزارة','جريدة','صحيفة','مجلة','وزارة','مشرف','رئيس','زعيم','موظف','عامل','مرافق','مراسل']
work2 = ['مدير مدرسه']
companions = ['شراكة','معية','مساهمة','مشترك','مشارك','مشاركين','مشاركون','مشاركة','مشتركة','اشترك','ساهم','اشتراك','الاشتراك','اشتراك','مشترك','مساهم' ]
companions2 = ['واحد من','واحدا من']
mention = ['قال','ذكر','أشار','كتب','يقول','يذكر','يشير']
help = ['عن طريق','بواسطة','بفضل','رعاية','رعا','يرعى','رعى']
